    ...
    try:
        ...
        if rows:
            ...
            intel["fundamentals"] = {
                ...
                "revenue_growth_qoq_pct": r["REVENUE_GROWTH_QOQ_PCT"],
                "revenue_growth_yoy_pct": r["REVENUE_GROWTH_YOY_PCT"],
                "net_income_growth_yoy_pct": r["NET_INCOME_GROWTH_YOY_PCT"],
                "eps_growth_yoy_pct": r["EPS_GROWTH_YOY_PCT"],
    ...
    try:
        ...
        if rows:
            ...
            intel["sentiment"] = {
                ...
                "sentiment_score_7d_avg": r["SENTIMENT_SCORE_7D_AVG"],
                "positive_ratio_pct": r["POSITIVE_RATIO_PCT"],
                "articles_7d_total": r["ARTICLES_7D_TOTAL"],
                "news_volume_momentum": r["NEWS_VOLUME_MOMENTUM"],
    ...
    try:
        ...
        if rows:
            ...
            intel["sec_financials"] = {
                ...
                "reporting_frequency": r["REPORTING_FREQUENCY"],
